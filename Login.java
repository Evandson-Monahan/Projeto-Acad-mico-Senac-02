...
public class Login extends javax.swing.JFrame {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(26, 80, 67));
        ...
        jLabel4.setText("para poder adicionar,");

        btnEntrar.setBackground(new java.awt.Color(0, 237, 182));
        btnEntrar.setFont(new java.awt.Font("Poppins Medium", 0, 24)); // NOI18N
        ...
        jLabel5.setText("editar e excluir tarefas");
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        if(rs.next()){
            AdicionarTarefas adicionarTarefas = new AdicionarTarefas();
